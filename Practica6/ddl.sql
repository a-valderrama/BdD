...
MODIFY ID_ESTADO VARCHAR(20) NOT NULL
MODIFY NOMBRE VARCHAR(30) NOT NULL
ADD CONSTRAINT nombre_dist_unique UNIQUE (NOMBRE);
...
MODIFY NOMBRE VARCHAR(30) NOT NULL
MODIFY ID_ESTADO VARCHAR(20) NOT NULL
MODIFY ID_DISTRITO VARCHAR(20) NOT NULL
MODIFY ID_MUNICIPIO VARCHAR(20) NOT NULL
...
MODIFY ID_COLONIA VARCHAR(20) NOT NULL;
...
MODIFY ID_DISTRITO VARCHAR(20) NOT NULL
MODIFY ID_MUNICIPIO VARCHAR(20) NOT NULL
MODIFY ID_PROPIEDAD VARCHAR(20) NOT NULL
MODIFY ID_COLONIA VARCHAR(20) NOT NULL
MODIFY CALLE VARCHAR(30) NOT NULL
MODIFY NUMERO NUMBER(5,0) NOT NULL
MODIFY CP NUMBER(6,0) NOT NULL
MODIFY ID_ESTADO VARCHAR(20) NOT NULL
...
MODIFY TAMAÑO NUMBER(10,2) NOT NULL
MODIFY FECHA_REGISTRO DATE NOT NULL
ADD CONSTRAINT fecha_registro_depa UNIQUE (FECHA_REGISTRO)
MODIFY NUM_HABITACIONES NUMBER(10) NOT NULL
MODIFY NUM_BAÑOS NUMBER(10) NOT NULL
MODIFY VALOR_CATASTRAL NUMBER(10,2) NOT NULL
MODIFY AREA_DE_LAVADO CHAR NOT NULL
MODIFY BALCON CHAR(1) NOT NULL
MODIFY ELEVADOR CHAR(1) NOT NULL
MODIFY MANTENIMIENTO CHAR(1) NOT NULL
MODIFY NIVEL NUMBER(3) NOT NULL
MODIFY NUM_TOTAL_DEPTOS NUMBER(5) NOT NULL;
...
MODIFY ID_SERVICIO VARCHAR(20) NOT NULL
MODIFY PAGO_ANUAL NUMBER(10,2) NOT NULL
MODIFY TIPO VARCHAR2(20) NOT NULL;
...
MODIFY ID_AREA_ESP VARCHAR(20) NOT NULL
MODIFY ID_PROPIEDAD VARCHAR(20) NOT NULL;
